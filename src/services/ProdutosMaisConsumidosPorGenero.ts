...
export default class ProdutosMaisConsumidosPorGenero extends Listagem {
  ...
  private agruparConsumo(genero: Genero) {
    ...
    return { produtosOrdenados, servicosOrdenados }
  }
  ...
  public listar(): void {
    ...
    generos.forEach(genero => {
      console.log(`\nConsumo para gênero: ${genero}`)
      const { produtosOrdenados, servicosOrdenados } = this.agruparConsumo(genero)
