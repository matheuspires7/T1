...
var ProdutosMaisConsumidosPorGenero = /** @class */ (function (_super) {
    __extends(ProdutosMaisConsumidosPorGenero, _super);
    function ProdutosMaisConsumidosPorGenero(empresa) {
        var _this = _super.call(this) || this;
        _this.empresa = empresa;
        return _this;
    }
    ProdutosMaisConsumidosPorGenero.prototype.agruparConsumo = function (genero) {
        var mapaProdutos = new Map();
        var mapaServicos = new Map();
        this.empresa.getClientes()
            .filter(function (c) { return c.getGenero().toUpperCase() === genero; })
        ...
        var servicosOrdenados = Array.from(mapaServicos.entries())
            ...
            .sort(function (a, b) { return b.quantidade - a.quantidade; });
        return { produtosOrdenados: produtosOrdenados, servicosOrdenados: servicosOrdenados };
    };
    ProdutosMaisConsumidosPorGenero.prototype.listar = function () {
        var _this = this;
        var generos = ["F", "M", "O"];
        generos.forEach(function (genero) {
            console.log("\nConsumo para g\u00EAnero: ".concat(genero));
            var _a = _this.agruparConsumo(genero), produtosOrdenados = _a.produtosOrdenados, servicosOrdenados = _a.servicosOrdenados;
    ...
    return ProdutosMaisConsumidosPorGenero;
}(Listagem_1.default));
exports.default = ProdutosMaisConsumidosPorGenero;
